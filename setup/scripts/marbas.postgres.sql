...
BEGIN
	IF TG_OP = 'UPDATE' THEN
		...
		END IF;
	ELSE
		IF new.derived_typedef_id IN('00000000-0000-1000-a000-000000000009', '00000000-0000-1000-a000-00000000000a', '00000000-0000-1000-a000-000000000004', '00000000-0000-1000-a000-000000000005') THEN
			RAISE EXCEPTION 'This TypeDef is not allowed as derived_typedef_id';
		END IF;
	END IF;
	RETURN new;
